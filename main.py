...
from car_publisher import CarPublisher
...
# Initialize modules
car_publisher = CarPublisher(bot, dp, db)
...
async def handle_main_actions(callback_query: types.CallbackQuery):
    ...
    if action == "find":
        ...
        await car_publisher.start_publishing(callback_query.message)
    elif action == "stats":
...
if __name__ == '__main__':
    logger.info("Starting ZalogAvtoUz Bot...")
